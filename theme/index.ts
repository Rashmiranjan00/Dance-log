...
const lineHeight = (modifier: number, fontSize: number) =>
  `${modifier * fontSize}px`;
...
export const BaseTheme: Theme = {
  ...
  toast: {
    success: {
      border_left_color: Colors.green_40,
      icon_color: Colors.green_40,
    },
